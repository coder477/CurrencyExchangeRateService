...
public class ExchangeRateIntegrationTest {
	...
	public void exchangeRate() {
		...
		final ResponseEntity<?> responseFailure = restTemplate.getForEntity(createURLWithPort("/2019-08-jj/USD/EUR"),
				Object.class);
		final ResponseEntity<?> responseHistory = restTemplate.getForEntity(createURLWithPort("/history/daily/2019/08/30"),
				Object.class);
		final ResponseEntity<?> responseHistoryFailure = restTemplate.getForEntity(createURLWithPort("/history/daily/2019/yy/30"),
				Object.class);
